...
Calculate your age by subtracting your birth year from 2020. gi
...
```{r, echo = TRUE, eval = TRUE, code = readLines("ex_ans/Q1b.R")}
```
...
###### Answer
```{r, echo = TRUE, eval = TRUE, code = readLines("ex_ans/Q3.R")}
```
...
# TODO: check if the github raw link is valid
height_weight <- readr::read_csv(here::here("dataset", "height_weight.csv"))
height_weight <- readr::read_csv("https://raw.github.com/psy218/r_tutorial/master/dataset/height_weight.csv")
```

###### Answer
```{r, echo = TRUE, eval = TRUE, code = readLines("ex_ans/Q5.R")}
```
