...
If we look at the data frame `birth_data`, you will notice that there is no new column named `sex` or a new row containing data from 22-year-old female who was born in Oct.   
```{r}
birth_data
```
...
or, create a new object with a different name.
```{r eval=FALSE}
